...
led_socket = led_context.socket(zmq.REP)
led_socket.bind("tcp://*:5557")
...
if __name__ == '__main__':
    ...
    try:
        ...
        while True:
            try:
                message = led_socket.recv(zmq.NOBLOCK)
                message = message.decode('utf8')
                r, g, b = message.split('_')
                colorWipe(strip, Color(int(r), int(g), int(b)), 10)
            except zmq.Again:
                pass
